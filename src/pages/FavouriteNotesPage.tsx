...
const FavouriteNotesPage: React.FC = () => {
  const { favouriteNotes, isLoading, getFavouriteNotes } = useNotes();
  ...
  const filteredNotes = favouriteNotes.filter((note: Note) =>
        ...
        <Content>
          <Header_Section>
            <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              <PageTitle>⭐ Favourite Notes</PageTitle>
              <PageSubtitle>Your most important and cherished notes</PageSubtitle>
            </motion.div>
          </Header_Section>
          ...
          <FiltersAndActions>
            <SearchInput
              type="text"
              placeholder="Search favourite notes..."
              value={searchQuery}
          ...
          {isLoading ? (
            ...
            >
              <EmptyIcon>⭐</EmptyIcon>
              <EmptyTitle>No Favourite Notes Yet</EmptyTitle>
              <EmptyMessage>
                Start marking your important notes as favourites to see them here
              </EmptyMessage>
            </EmptyState>
          )}
        </Content>
...
export default FavouriteNotesPage;

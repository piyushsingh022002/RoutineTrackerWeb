      ...
      <PageContainer>
        <Content>
          <Header_Section>
            ...
            <PageSubtitle>Organize and manage all your notes in one place</PageSubtitle>
          </Header_Section>
          ...
          {isLoading ? (
            ...
            <EmptyState initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
              <EmptyIcon>📚</EmptyIcon>
              <EmptyTitle>No notes yet</EmptyTitle>
              <EmptyMessage>
                {searchQuery ? 'No notes match your search. Try a different query.' : 'Start creating notes to organize your thoughts and ideas.'}
              </EmptyMessage>
              {!searchQuery && (
                <CreateButton
                  whileHover={{ scale: 1.05 }}
